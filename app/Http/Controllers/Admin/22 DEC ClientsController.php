...
class ClientsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        File::makeDirectory($path, $mode = 0777, true, true);
	     $myfile = fopen(public_path()."/css/".$folder."/default.css", "w") or die("Unable to open file!");
        ...
        // Copy google.css to client Folder
        $filename = public_path().'/css/google.css';
        File::copy($filename,$path.'/google.css');
	...
	public function store_user_of_client(Request $request, $client_id, $is_users_of_client_active) {
        ...
        $user->save();
         ...
         // Create client Folder
		$path = public_path().'/css/'.$request->username;
        File::makeDirectory($path, $mode = 0777, true, true);
        // Copy google.css to client Folder
        $filename = public_path().'/css/google.css';
        File::copy($filename,$path.'/google.css');
