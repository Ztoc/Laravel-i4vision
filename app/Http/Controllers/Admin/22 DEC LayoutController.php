...
class LayoutController extends Controller
{
    ...
    public function index()
    {
        ...
        $filename = $path.'/default.css';
        $default_google_layout = File::get($filename);
        return view('admin/layout/index', ['layout' => $layout, 'default_google_layout' => $default_google_layout, 'page_name' => self::PAGE_NAME]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/layout/edit', ['layout' => $layout,'default_google_layout'=>$default_google_layout,'page_name' => self::PAGE_NAME ]);
    }
    ...
    public function edit_default_google_layout()
    {

        $folder =  strtolower(Auth::user()->client->name);
        $filename = public_path().'/css/'.$folder.'/default.css';
        $default_google_layout = File::get($filename);

        if (empty($default_google_layout)) {
            return redirect(route('admin.layout'))->with('warning', 'warning.');
        }

        return view('admin/layout/edit_default_google_layout', ['default_google_layout'=>$default_google_layout ,'page_name' => self::PAGE_NAME ]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update_default_google_layout(Request $request)
    {
		...
		$path = public_path().'/css/'.$folder;
        $filename = public_path().'/css/'.$folder.'/google.css';
        ...
        return redirect(url('admin/layout/edit_default_google_layout'))->with('success', 'Google layout was updated.');
    }
